...
2024 年 5 月 15 日，为解决瑞士轮赛制难以快速理解的问题，RM Schedule 在不到一天内完成首版开发、上线和宣传。首个版本已经能够获取官方赛程数据，将比赛、排名和预测席位组织为关系图，并展示实时比分、比赛状态与竞猜支持率。此后数周，项目陆续加入赛区切换、定时刷新、画布拖动和缩放等基础能力，使赛程图能够跟随区域赛进程持续更新。
