        ...
        zones: [
          {
            ...
            winners: [],
            losers: [],
            text: ['第一梯队种子 A1', '抽签结果待定 A9', '第二梯队种子 A2', '抽签结果待定 A10', '抽签结果待定 A11', '第一梯队种子 A3', '抽签结果待定 A12', '第二梯队种子 A4', '第一梯队种子 A5', '抽签结果待定 A13', '第二梯队种子 A6', '抽签结果待定 A14', '抽签结果待定 A15', '第一梯队种子 A7', '抽签结果待定 A16', '第二梯队种子 A8']
          },
          {
            matches: [9, 10, 11, 12, 13, 14, 15, 16],
            winners: [],
            losers: [],
            text: ['抽签结果待定 B9', '第一梯队种子 B1', '抽签结果待定 B10', '第二梯队种子 B2', '第一梯队种子 B3', '抽签结果待定 B11', '第二梯队种子 B4', '抽签结果待定 B12', '抽签结果待定 B13', '第一梯队种子 B5', '抽签结果待定 B14', '第二梯队种子 B6', '第一梯队种子 B7', '抽签结果待定 B15', '第二梯队种子 B8', '抽签结果待定 B16']
          }
        ]
      }
    },
...
export const GetGroupZoneKnockoutJsonData = (zoneId: number): ZoneJsonData => {
  return <ZoneJsonData>{
    ...
    lines: [
      ...
      { from: '#7', to: '#12', },
      { from: '#8', to: '#12', },
      { from: '#9', to: '#13', className: 'knockout-cross-line-right' },
      { from: '#10', to: '#14', className: 'knockout-cross-line-right' },
      { from: '#11', to: '#13', className: 'knockout-cross-line-left', isHideArrow: true },
      { from: '#12', to: '#14', className: 'knockout-cross-line-left', isHideArrow: true },
      { from: '#13', to: '#15', },
      { from: '#14', to: '#15', },
      { from: '#13', to: '#16', },
      { from: '#14', to: '#16', },
