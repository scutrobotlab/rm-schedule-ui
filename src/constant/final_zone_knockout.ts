...
export const FinalZoneKnockoutLoserJsonData: ZoneJsonData = {
  ...
  lines: [
    ...
    { from: '#3', to: '#7', },
    { from: '#4', to: '#8', },
    { from: '#5', to: '#9', className: 'knockout-cross-line-right' },
    { from: '#6', to: '#10', className: 'knockout-cross-line-right' },
    { from: '#7', to: '#9', className: 'knockout-cross-line-left', isHideArrow: true },
    { from: '#8', to: '#10', className: 'knockout-cross-line-left', isHideArrow: true },
    { from: '#9', to: '#11', },
    { from: '#10', to: '#12', },
  ],
}
